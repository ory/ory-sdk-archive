#!/bin/sh
set -e
# Code generated by godownloader on 2019-04-01T12:47:28Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for ory/ory

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/ory/ory/releases
